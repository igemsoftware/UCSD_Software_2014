...
def create_input_transition_nodes(cursor, starting_species_list, operon_id, it_id_dict):
    ...
    print "activated_it_ids:", activated_it_ids
...
create_input_transition_nodes(cursor, ['20', '21', '9', '32'], '1-1', it_id_dict)
...
create_subnetwork_path(cursor, ['20', '21', '9', '32'], ["1-1"], it_id_dict)
###create_subnetwork_path(cursor,["8-1", "21-2"], ["2", "13"])
...
def get_subnetwork(cursor, list_of_operon_paths): 
    ...
    print "list_of_operon_paths:", list_of_operon_paths
    
    for operon_path in list_of_operon_paths:
        
        species_set, input_transition_set, operon_set, output_transition_set, edge_path_list =        create_subnetwork_path(cursor, starting_species_list, operon_path, it_id_dict)
...
###get_subnetwork(cursor, [['20', '21', '9', '32'], ["1-1"])

get_subnetwork(cursor,[["2", "13","20","21"], ["8-1", "21-2"], ["1-1"]])
...
def create_json_network(json_file_path, species_nodes_list, input_transitions_nodes_list, 
    ...
    for edge in source_id_target_id_list:
        ...
        #EEGE ID IS DEFINITELY A PROBLEM PLEASE FIX
...
###conn, cursor = db.db_open("sbider.db")
###create_subnetwork_path(cursor,["8-1", "21-2"], ["2", "13"])
###get_subnetwork(cursor,[["8-1", "21-2"], ["1-1"]] , [["2", "13"], ["20","21"]])
###create_subnetwork_json(cursor,[["2", "13","20","21"],["8-1", "21-2"], ["1-1"]])
